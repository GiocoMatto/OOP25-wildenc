...
come ad esempio portata, danno e velocità di attacco, con cui attacheranno passivamente durante tutta la partita.
%
...
di registrare gli input del giocatore e di associarli a delle azioni delle varie entità presenti nel gioco che costituiscono
...
%
Nella \autoref{uml:architecture} è illustrata ed evidenziata l'architettura descritta.

\begin{figure}[H]
	\includegraphics[width=13cm]{Architecture}
	\caption{Schema UML che evidenzia la struttura MVC delle varie componenti del progetto}\label{uml:architecture}
\end{figure}
